...
const PreviousDocuments: React.FC<PreviousDocumentsProps> = ({
  ...
  const getColumns = () => {
    // Define column types to match Table requirements
    type ColumnType = {
      title: string;
      key: string;
      dataIndex?: string;
    ...
    // Add Type column for medium screens and larger
    if (windowWidth >= 640) {
    ...
    // Add Namespace column for large screens
    if (windowWidth >= 1024) {
  ...
  // Custom render for mobile card view
